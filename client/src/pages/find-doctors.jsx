...
const FindDoctors = () => {
  ...
  // State for which search tab is active
  ...
  useEffect(() => {
    ...
    // Set the advanced tab if specifically requested
    if (searchParams.has('advanced') && searchParams.get('advanced') === 'true') {
  ...
  return (
    <div>
      <div className="container mx-auto px-4 py-6">
        <h1 className="text-3xl font-bold mb-6">Find The Perfect Doctor</h1>
        
        <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8">
            <TabsTrigger value="standard">Standard Search</TabsTrigger>
            <TabsTrigger value="advanced">AI-Powered Recommendations</TabsTrigger>
          </TabsList>
      ...
      {/* More Filters Sheet (for standard search) */}
